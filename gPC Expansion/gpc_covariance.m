...
% This function computes covariance between two random processes (x and y),
% given the coefficients of gPC expansion (x_c and y_c) of both x and y.
% Instead, if y_c is not provided or empty, the function computes the
% auto-covariance of random process x.
%
% Inputs:
